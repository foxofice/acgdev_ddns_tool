...
#pragma region Send
// Client 发送 Ping
// Link: ../../ddns_server/Packet/packet.h : recv_Ping)
NNN_API bool	send_Ping(class NNN::Socket::c_Client *client);

// 【登录验证】

// Client 发送「登录数据」
// Link: ../../ddns_server/Packet/packet.h : recv_Login_Data)
...
// Link: ../../ddns_server/Packet/packet.h : recv_Update_Domains)
...
// Server 发送心跳包
// Link: ../../ddns_server/Packet/packet.h : send_KeepAlive(
PARSE_FUNC(recv_KeepAlive);

// Server 回应 Ping
// Link: ../../ddns_server/Packet/packet.h : send_Ping(
PARSE_FUNC(recv_Ping, __out double &ping);

// 【登录验证】

// Server 发送 KeyIV
// Link: ../../ddns_server/Packet/packet.h : send_KeyIV(
...
// Server 发送「登录结果」
// Link: ../../ddns_server/Packet/packet.h : send_Login_Result(
PARSE_FUNC(recv_Login_Result, __out es_Result &result);

//【登录验证后】

// Server 发送「更新域名的 A/AAAA 记录的结果」
// Link: ../../ddns_server/Packet/packet.h : send_Update_Domains_Result(
...
// Server 发送 Log
// Link: ../../ddns_server/Packet/packet.h : send_Log(
PARSE_FUNC(	recv_Log,
			const BYTE							Key[AES_KEY_LEN],
			const BYTE							IV[AES_IV_LEN],
