...
namespace ddns_lib
{
	public class LANGUAGES
	{
		...
		public static c_Language?	m_s_current_language	= null;

		// culture_name -> c_Language
		public static SortedDictionary<string, c_Language>	m_s_LanguagesList	= new();
		 ...
		 * 设置当前语言
		 *==============================================================*/
		public static void	set_language(string culture_name)
		{
		 ...
		 * 设置默认语言
		 *==============================================================*/
		public static void	set_language_to_default()
		{
		 ...
		 * 获取文本
		 *==============================================================*/
		public static string	txt(int num)
		{
