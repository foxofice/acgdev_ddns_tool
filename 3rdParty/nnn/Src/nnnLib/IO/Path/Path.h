...
// 返回指定路径字符串的文件名和扩展名
NNN_API HRESULT	get_filename(const WCHAR *path, __out WCHAR filename[MAX_PATH]);
NNN_API HRESULT	get_filename(const char *path, __out char filename[MAX_PATH]);

// 返回不具有扩展名的指定路径字符串的文件名
NNN_API HRESULT	get_filename_without_extension(const WCHAR *path, __out WCHAR filename[MAX_PATH]);
NNN_API HRESULT	get_filename_without_extension(const char *path, __out char filename[MAX_PATH]);

// 获取文件扩展名
NNN_API HRESULT	get_file_extension(const WCHAR *filename, __out WCHAR extension[MAX_PATH]);
NNN_API HRESULT	get_file_extension(const char *filename, __out char extension[MAX_PATH]);

// 获取给定路径的目录和文件名
NNN_API HRESULT	get_dir_and_filename(const char path[MAX_PATH], __out char dir[MAX_PATH], __out char filename[MAX_PATH]);
NNN_API HRESULT	get_dir_and_filename(const WCHAR path[MAX_PATH], __out WCHAR dir[MAX_PATH], __out WCHAR filename[MAX_PATH]);
